...
##    image.save(os.path.join("out", "output.png"), quality=90)
##
##    # Display the results in the notebook
##    #output_image = scipy.misc.imread(os.path.join("out", image_file))
##    output_image = scipy.misc.imread(os.path.join("out", "output.png"))
##
##    plt.figure(figsize=(12,12))
##    imshow(output_image)
##    im = cv2.resize(output_image,(int(output_image.shape[1]/6),int(output_image.shape[0]/6)))
